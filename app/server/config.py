...
WAREHOUSE_ID = os.environ.get("SQL_WAREHOUSE_ID", "ae8786c45629ac32")
DASHBOARD_ID = os.environ.get("DASHBOARD_ID", "01f1822e23281b84862d425ca9ef6f5d")
...
def get_workspace_client() -> WorkspaceClient:
    ...
    profile = os.environ.get("DATABRICKS_PROFILE", "fe-vm-wildlife-s2s")
